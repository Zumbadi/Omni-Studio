...
export const reviewBuildTask = async (
    ...
    try {
        ...
        const parsed = safeParseJSON(response.text || '', { approved: true, feedback: "JSON Parse Error (Auto-Pass)", issues: [] });
